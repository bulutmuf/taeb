...
const webinars = [
  {
    ...
    link: `${contactInfo.social.youtube}?q=Klinik+Eczacılık+TAEB`,
  ...
  },
  {
    ...
    link: `${contactInfo.social.youtube}?q=Yurt+Dışı+Burs+Staj+TAEB`,
  ...
  },
  {
    ...
    link: `${contactInfo.social.youtube}?q=E-Reçete+TAEB`,
...
export default function WebinarSection() {
  ...
  return (
    <section>
      <div className="mb-12">
        <SectionHeading
          badge={t("media.webinarBadge")}
          title={t("media.webinarTitle")}
          description={t("media.webinarDescription")}
          badgeTheme="surface"
        />
        <p className="mt-4 text-sm font-medium text-on-surface-variant">
          {t("media.webinarYoutubeNote")}
        </p>
      </div>
        ...
        {webinars.map((webinar) => (
          ...
          >
            <div className="aspect-video bg-surface-variant/20 relative overflow-hidden flex items-center justify-center">
              <img
                ...
                onError={(e) => {
                  (e.target as HTMLImageElement).src =
                    'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="600" height="400" fill="%23f3f4f6"><rect width="100%25" height="100%25" fill="%23f3f4f6"/><text x="50%25" y="50%25" font-family="sans-serif" font-size="24" fill="%239ca3af" text-anchor="middle" dominant-baseline="middle">VİDEO KAPAK EKLENECEK</text></svg>';
                }}
              />
              ...
              <div className="absolute top-3 right-3 z-30 rounded-full bg-red-600 px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-white">
                YouTube
              </div>
            </div>
            <div className="p-6">
