...
export const studentBoard: BoardMember[] = [
  ...
  { name: "Beyzanur Aslandoğan", roleEn: "Education & Projects", roleTr: "Eğitim ve Proje", linkedin: "" },
  { name: "Gülşen Ebrar Çapar", roleEn: "Social Events", roleTr: "Sosyal Etkinlik", linkedin: "" },
  { name: "Yağmur Erinkurt", roleEn: "Social Events", roleTr: "Sosyal Etkinlik", linkedin: "" },
  { name: "Mustafa Emre Ergüler", roleEn: "Social Events", roleTr: "Sosyal Etkinlik", linkedin: "" },
  { name: "Mısra Dilara Dönmez", roleEn: "Social Events", roleTr: "Sosyal Etkinlik", linkedin: "" },
  { name: "İlberk İnan Perçin", roleEn: "Sponsorships & Ptnrs", roleTr: "Sponsorluk ve İş Birliği", linkedin: "" },
  { name: "Şeyma Rana Karakaş", roleEn: "Sponsorships & Ptnrs", roleTr: "Sponsorluk ve İş Birliği", linkedin: "" },
  { name: "Zeynep Bulut", roleEn: "Magazine & Publications", roleTr: "Dergi ve Yayın", linkedin: "" },
  { name: "Nazlıcan Koç", roleEn: "Secretary General", roleTr: "Genel Sekreter", linkedin: "" },
  { name: "Güneş Böke", roleEn: "Communications", roleTr: "İletişim Sorumlusu", linkedin: "" },
];
